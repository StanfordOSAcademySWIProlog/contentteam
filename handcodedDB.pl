:- module(handcodedDB, [major/2,course/5,requirement/2]).
...
course('CSE 30',"Computer Organization and Systems Programming",exactly(4),"Introduction to organization of modern digital computersunderstanding the various components of a computer and their interrelationships. Study of a specific architecture/machine with emphasis on systems programming in C and Assembly languages in a UNIX environment.",'CSE 12, CSE 15L, or consent of instructor.').
